...
public class EnhancedDoorsBlocks {
	...
	public static final BlockEntityType<DoorBlockEntity> ANIMATED_DOOR_ENTITY = create("animated_door", FabricBlockEntityTypeBuilder.create(DoorBlockEntity::new).build());
